...
test.describe('Redesign-A — AiInsightsPanel', () => {
  ...
  test('TC-RA-AI-00 — documents page loads', async ({ page }) => {
  ...
  test.skip('TC-RA-AI-01 — selecting a document shows ai-insights-panel', async ({ page }) => {
    await page.goto('/documents')
  ...
  test.skip('TC-RA-AI-02 — ai-insights-panel renders at least one section', async ({ page }) => {
    await page.goto('/documents')
  ...
  test.skip('TC-RA-AI-03 — ai-insights-panel collapses on header click', async ({ page }) => {
    await page.goto('/documents')
