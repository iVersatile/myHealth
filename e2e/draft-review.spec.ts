...
test.describe('Phase 61 — Draft Entity Review UI', () => {
  ...
  test.skip('TC-DRAFT-04 — draft-entity-card visible on Contacts page after upload', async ({ page }) => {
    // Requires real Tauri upload to create draft entities in SQLite
    void page
  })

  test.skip('TC-DRAFT-05 — draft card shows DRAFT badge', async ({ page }) => {
    // Requires real Tauri upload
    void page
  })

  test.skip('TC-DRAFT-06 — Accept button present on draft card', async ({ page }) => {
    // Requires real Tauri upload
    void page
  })

  test.skip('TC-DRAFT-07 — Reject button present on draft card', async ({ page }) => {
    // Requires real Tauri upload
    void page
  })

  test.skip('TC-DRAFT-08 — accepting draft removes card optimistically', async ({ page }) => {
    // Requires real Tauri upload
    void page
  })

  test.skip('TC-DRAFT-09 — rejecting draft removes card optimistically', async ({ page }) => {
    // Requires real Tauri upload
    void page
  })

  test.skip('TC-DRAFT-10 — Merge button opens merge dialog when duplicate detected', async ({ page }) => {
    // Requires real Tauri upload with duplicate detection
    void page
  })

  test.skip('TC-DRAFT-11 — draft-review-section visible on Clinics page after upload', async ({ page }) => {
    // DraftEntitySection returns null when no drafts exist; requires Tauri
    void page
  })

  test.skip('TC-DRAFT-12 — draft-review-section visible on Symptoms page after upload', async ({ page }) => {
    // Requires real Tauri upload
    void page
  })

  test.skip('TC-DRAFT-13 — draft-review-section visible on Medications page after upload', async ({ page }) => {
    // Requires real Tauri upload
    void page
  })

  test('TC-DRAFT-14 — non-regression: contacts list excludes draft rows', async ({ page }) => {
    await page.goto('http://localhost:3000/contacts')
  ...
  test('TC-DRAFT-15 — non-regression: clinics list excludes draft rows', async ({ page }) => {
  ...
  test.skip('TC-DRAFT-16 — draft section shows empty state when all drafts resolved', async ({ page }) => {
